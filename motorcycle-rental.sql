...
--
-- Host: localhost
-- Generation Time: Dec 15, 2015 at 10:31 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_rental`(IN `motorcycle_id` INT, IN `firstname` VARCHAR(150) CHARSET utf8, IN `lastname` VARCHAR(150) CHARSET utf8, IN `cznum` VARCHAR(100) CHARSET utf8, IN `dlnum` VARCHAR(100) CHARSET utf8, IN `phone` VARCHAR(15) CHARSET utf8, IN `type` ENUM('day','month') CHARSET utf8, IN `amount` INT, IN `price` INT, IN `collateral` INT, IN `dre` DATE)
BEGIN
...
(9, 2, 'MSX 125', 'บษจ 111', 65000, 3000, 500, 13000, 'avaliable'),
...
INSERT INTO `rental` (`id`, `motorcycle_id`, `firstname`, `lastname`, `cznum`, `dlnum`, `phone`, `type`, `amount`, `price`, `collateral`, `date_rent`, `date_return_expect`, `date_return_returned`, `nrepair`, `fine`) VALUES
(1, 10, 'John', 'Smith', '0340296446GBR79092555M141106506', 'DB 09875-25', '0904872782', 'day', 5, 600, 4000, '2015-12-08', '2015-12-13', NULL, 0, NULL),
(2, 13, 'Saijai', 'Patthadee', '1702488045286', '95230751', '0854875415', 'day', 5, 700, 4000, '2015-11-15', '2015-11-20', '2015-11-20', 1, 1700),
(3, 7, 'Somsee', 'Meekin', '8279994993554', '06886825', '0815475245', 'day', 3, 400, 3000, '2015-12-07', '2015-12-10', NULL, 0, NULL),
(4, 16, 'Samas', 'Bunwan', '1914851732392', '43633269', '0954857848', 'month', 1, 7300, 0, '2015-11-15', '2015-12-15', '2015-12-12', 1, 1500),
(5, 2, 'Seungeun', 'Ja', 'EO7335386', 'DL464258', '0828784575', 'day', 5, 1000, 5000, '2015-12-15', '2015-12-20', NULL, 0, NULL),
(6, 17, 'Somchai', 'Angdee', '1346590181964', '35039004', '0815213454', 'day', 4, 1000, 5000, '2015-11-15', '2015-11-19', '2015-11-21', 1, 1200),
(7, 12, 'Jirat', 'Sandee', '2202559153071', '88054965', '0812482542', 'month', 1, 10000, 500, '2015-12-15', '2016-01-15', NULL, 0, NULL),
(8, 6, 'Wisead', 'Damrong', '5633871407963', '99504542', '0912424884', 'day', 5, 350, 0, '2015-12-11', '2015-12-16', NULL, 0, NULL),
(9, 1, 'Kanya', 'Intone', '5240109185748', '70722960', '0841524547', 'day', 2, 200, 0, '2015-12-14', '2015-12-16', NULL, 0, NULL);
